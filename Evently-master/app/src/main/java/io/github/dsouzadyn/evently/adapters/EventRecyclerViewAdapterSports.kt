 ...
 */
class EventRecyclerViewAdapterSports(private val mValues: List<EventContentSports.EventItem>, private val mUid: String) : RecyclerView.Adapter<EventRecyclerViewAdapterSports.ViewHolder>() {
    ...
    inner class ViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        var mItem: EventContentSports.EventItem? = null
