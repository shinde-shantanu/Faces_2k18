...
object EventContent {
    ...
    , start_time: String, end_time: String, start_time2: String, end_time2:String, start_time3: String, end_time3: String,
    ...
    class EventItem(val id: String, val name: String, val description: String, val capacity: Int,
                    ...
                    val start_time3: String, val end_time3: String, val price: Float,
