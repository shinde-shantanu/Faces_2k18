...
class DayFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            ...
            recyclerView.adapter = DaysRecyclerViewAdapter(DayContent.ITEMS, mListener)
        }
        return view
    }
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onListFragmentInteraction(item: DayContent.DayItem)
    }
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int): DayFragment {
