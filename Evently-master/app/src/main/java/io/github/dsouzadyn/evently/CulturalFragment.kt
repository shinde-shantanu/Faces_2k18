...
import io.github.dsouzadyn.evently.adapters.EventRecyclerViewAdapterCultural
 ...
 * [CulturalFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [CulturalFragment.newInstance] factory method to
...
class CulturalFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        EventContentCultural.ITEMS.clear()
        EventContentCultural.clearitemslist()
...
//                     }
                    ...
                    events?.filterIndexed { index, value ->
                        ...
                        EventContentCultural.addItem(
                                EventContentCultural.createEventItem(
                                        i++,
                                        e.id,
                                        e.name,
                                        e.description,
                    ...
                    if (EventContentCultural.ITEMS.size > 0) {
                        progressDialog.dismiss()
                        //toast("suc")
                        if (view is RecyclerView) {
                            ...
                            view.adapter = EventRecyclerViewAdapterCultural(EventContentCultural.ITEMS, uid)
                        }
                    }
                }
                else{
